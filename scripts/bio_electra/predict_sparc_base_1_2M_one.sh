...
python run_finetuning.py --predict --data-dir $DATA_DIR --model-name bio_electra_base_1_2M --hparams '{"model_size": "base", "task_names": ["sparc"], "max_seq_length":128, "train_batch_size":16, "use_tfrecords_if_existing": false, "vocab_file": "'"$CONNECTIVITY_RE_HOME"'/scripts/bio_electra/data/pmc_2017_abstracts_wp_vocab_sorted.txt", "vocab_size": 31620, "num_trials": 1, "write_test_outputs": true, "n_writes_test": 1}'
