package bnlp.re.sparc.ontology;
...
public class OntologyLookupManager {
    ...
    public void dumpTerms(String outFile) throws IOException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ontologyLTFileList.add(new File(HOME_DIR + "/dev/java/bnlp-re/data/sparc/fmaslimroots-sparcview-sparccommunity-classes-with-labels-synonyms-parents.json"));

        OntologyLookupManager olm = new OntologyLookupManager();
        olm.load(ontologyLTFileList);
        String outFile = "/tmp/sparc_vocabulary.txt";
        olm.dumpTerms(outFile);
